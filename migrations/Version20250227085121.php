 ...
 */
final class Version20250227085121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, voiture_id INT NOT NULL, proprietaire_id INT NOT NULL, date_creation DATE NOT NULL, date_disponibilite DATE DEFAULT NULL, lieu_garage VARCHAR(100) NOT NULL, prix NUMERIC(10, 2) NOT NULL, disponibilite TINYINT(1) NOT NULL, description LONGTEXT DEFAULT NULL, date_debut_disponibilite DATE DEFAULT NULL, date_fin_disponibilite DATE DEFAULT NULL, INDEX IDX_AF86866F181A8BA (voiture_id), INDEX IDX_AF86866F76C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE proprietaire (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, UNIQUE INDEX UNIQ_69E399D6FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
